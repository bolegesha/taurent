...
export default async function ContactPage({
  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:px-8">
      <h1 className="mb-8 text-4xl font-bold">{messages.contact.title}</h1>
      
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
        <div>
          <div className="flex flex-col gap-6 rounded-lg bg-white p-6 shadow-md">
            <h2 className="text-2xl font-semibold">
              {locale === 'en' ? 'Get In Touch' : 'Свяжитесь с нами'}
            </h2>
            ...
            <div className="mt-6">
              <h3 className="mb-3 text-lg font-medium">
                {locale === 'en' ? 'Follow Us' : 'Следите за нами'}
              </h3>
              <div className="flex gap-4">
                <a
                  href="#"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 hover:bg-primary/10"
                >
